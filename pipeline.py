...
def run_scan():
  ...
  dt_file = "d_" + instant
  filestring = "sudo zmap -B 15M --probe-module=icmp_echoscan --whitelist-file=\"" + WHITELIST_FILE + "\" -o " + dt_file
  print(filestring) 
 
  subprocess.call("touch " + dt_file +" && sudo zmap -B 15M --probe-module=icmp_echoscan --whitelist-file=\"" + WHITELIST_FILE + "\" -o " + dt_file)
